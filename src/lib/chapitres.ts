...
export const CHAPITRES: Chapitre[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        sourceModule: null,
        status: "available",
        teaser: "Le jour J. Ni trop tôt, surtout pas trop tard.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    modules: [
      {
        slug: "guide",
        title: "Apprendre à déguster",
        sourceModule: null,
        status: "available",
        teaser: "Œil, nez, bouche — chaque étape avec les bons mots.",
      },
      {
        slug: "carnet",
        ...
        sourceModule: null,
        status: "available",
        teaser: "Tes dégustations s'accumulent. Ton palais se dessine.",
      },
      {
      ...
      },
      {
        ...
        sourceModule: null,
        status: "coming-soon",
        teaser: "Les questions qu'on n'ose pas poser, en 90 secondes chacune.",
      },
    ],
  },
];
